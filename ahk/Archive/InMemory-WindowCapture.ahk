...
; Citation(s)
;
;   autohotkey.com  |  "In-memory Window Capture - Page 2 - Scripts and Functions - AutoHotkey Community"  |  https://autohotkey.com/board/topic/22675-in-memory-window-capture/page-2
;
; ------------------------------------------------------------