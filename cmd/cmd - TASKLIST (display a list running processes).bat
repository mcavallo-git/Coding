...
SET ECHO_TIMESTAMP=%ECHO_YEAR%-%ECHO_MONTH%-%ECHO_DAY%_%ECHO_HR%-%ECHO_MIN%-%ECHO_SEC%.%ECHO_MILLISEC%

SET TEMPFILE_TIMESTAMP=%TMP%\bat_%ECHO_TIMESTAMP%-%ECHO_MILLISEC%.tmp
