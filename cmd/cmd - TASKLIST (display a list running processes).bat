...
REM ------------------------------------------------------------
REM Get Last Sync-Time from WMIC
...
SET /A YEARS_SINCE_LAST_SYNC=(((REMAINING_SECONDS/31536000)%31536000+31536000)%31536000)
SET /A REMAINDER_SECONDS=REMAINDER_SECONDS-(YEARS_SINCE_LAST_SYNC*31536000)
SET /A MONTHS_SINCE_LAST_SYNC=(((REMAINING_SECONDS/2628000)%2628000+2628000)%2628000)
SET /A REMAINDER_SECONDS=REMAINDER_SECONDS-(MONTHS_SINCE_LAST_SYNC*2628000)
SET /A DAYS_SINCE_LAST_SYNC=(((REMAINING_SECONDS/86400)%86400+86400)%86400)
