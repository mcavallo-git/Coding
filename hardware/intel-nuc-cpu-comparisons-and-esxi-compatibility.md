...
| <h4>NUC Generation</h4>         | <h4>Family (Kit) Type</h4> | <h4>NUC Model</h4> | <h4>CPU Model</h4>           | <h4>CPU Thread Count</h4> | <h4>CPU Core Count</h4> | <h4>CPU Frequency (Base/Max)</h4> |
| ------------------------------- | -------------------------- | ------------------ | ---------------------------- | ------------------------- | ----------------------- | --------------------------------- |
| <hr />                          | <hr />                     | <hr />             | <hr />                       | <hr />                    | <hr />                  | <hr />                            |
| `NUC13` <sub>*(13th Gen)*</sub> | `Extreme`                  | `NUC13RNGi9`       | `i9-13900K`                  | `32`                      | `8P`+`16E`              | `P:3.0/5.4 GHz` , `E:2.2/4.3 GHz` |
