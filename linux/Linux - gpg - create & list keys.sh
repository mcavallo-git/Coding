...
# Citation(s)
#
#   wiki.archlinux.org  |  "GnuPG"  |  https://wiki.archlinux.org/index.php/GnuPG
#
#   www.gnuprg.org  |  "Using the GNU Privacy Guard"  |  https://www.gnupg.org/documentation/manuals/gnupg.pdf
#
#   www.gnuprg.org  |  "Making and verifying signatures"  |  https://www.gnupg.org/gph/en/manual/x135.html
#
#   git.gnupg.org  |  "GnuPG Details"  |  https://git.gnupg.org/cgi-bin/gitweb.cgi?p=gnupg.git;a=blob_plain;f=doc/DETAILS
#
#   wiki.debian.org  |  "Using OpenPGP subkeys in Debian development"  |  https://wiki.debian.org/Subkeys
#
#   help.github.com  |  "Generating a new GPG key"  |  https://help.github.com/en/articles/generating-a-new-gpg-key
#
# ------------------------------------------------------------
