...
#  |--> Prompt for user confirmation  (press 'y' to confirm)
#
...
VAR1="STRING";
VAR2="string";
if [ "${VAR1}" = "${VAR2}" ]; then echo 1; else echo 0; fi;  # Returns 0 (no match)
if [ "${VAR1,,}" = "${VAR2,,}" ]; then echo 1; else echo 0; fi;  # Returns 1 (successful match)
...
read -p "Your response:  " -n 1 -t 60 <'/dev/tty'; # Await single keypress
