...
Get-Module | Sort-Object -Property Name,Version | Select-Object -Property Name, Version, Path, RootModule | Format-List;


# Get specific PowerShell modules  ( which exist in ${env:PSModulePath} )
Get-Module -ListAvailable @("PackageManagement","PowerShellGet") | Sort-Object -Property Name,Version | Select-Object -Property Name, Version, Path, RootModule | Format-List;
...
Get-Module -ListAvailable @("PackageManagement","PowerShellGet") | Sort-Object -Property Name,Version | Select-Object -Property Name, Version, Path, RootModule | Format-Table | Out-String -Width 500;
...
If ($True) {
  ...
  (Get-Module -ListAvailable @("PackageManagement","PowerShellGet") | Sort-Object -Property Name,Version | ForEach-Object {
    "-- "*20;
    $_ | Select-Object -Property Name, Version, Path | Format-List | Out-String;
    If (($_.Path) -NE ($_.RootModule)) {
      # Only drill down on $_.RootModule details that aren't immediately apparent from the $_.Path
