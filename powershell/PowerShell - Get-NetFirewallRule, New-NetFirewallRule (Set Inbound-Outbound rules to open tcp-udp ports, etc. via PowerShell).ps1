...
<# Create a firewall rule to allow TCP 21 (FTP) through #> 
...
<# Create a firewall rule to allow TCP 80 & 443 (HTTP, HTTPS) through #> 
...
<# Create a new firewall rule to allow TCP 9000 (Minio) service through #>
...
<# Create a new firewall rule to allow TCP 27017 (MongoDB) service through #>
...
<# Create a new firewall rule to allow TCP 3389 (Microsoft SQL) service through #>
...
<# Create a new firewall rule to allow ICMP 4 (Pings) service through #>
New-NetFirewallRule `
