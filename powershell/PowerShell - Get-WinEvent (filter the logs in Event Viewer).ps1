...
$LogonLogoff_AllEvents = (Get-EventLog -LogName "Security" | Where-Object {@(1,2,4624,4647,4778,4779,4800,4801,6000,6005) -Contains ($_.InstanceId)} | Select-Object UserName,TimeGenerated,Message);
$LogonLogoff_AllEvents;
