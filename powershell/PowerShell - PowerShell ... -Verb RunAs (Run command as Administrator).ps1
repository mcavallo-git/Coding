...
Start-Process -Filepath ("${env:ProgramFiles}\AutoHotkey\v2\AutoHotkey.exe") -ArgumentList ("${env:USERPROFILE}\Documents\GitHub\Coding\ahk\_WindowsHotkeys.ahkv2") -Verb RunAs;
...
<# PowerShell/pwsh - Run as admin (child terminal) - Run Get-SystemSpecs #>
