...
#	Citation(s)
#
#		docs.microsoft.com | About Automatic Variables
#			https://docs.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_automatic_variables?view=powershell-5.1 | 2019-05-21_10-37-41
#
