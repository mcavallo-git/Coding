function Az_AppInsights_Frontend {
  Param(
  ...
  $az.webapp = @{};
  $az.webapp.name = (($az.epithet)+("-insights"));
  ...
  $CommandDescription = (("Configuring [ Application Settings ] for Web-App `"")+($az.webapp.name)+("`""));
	...
	$az.webapp.appSettings["APPINSIGHTS_PROFILERFEATURE_VERSION"] = "disabled";

  $az.webapp.appSettings["APPINSIGHTS_SNAPSHOTFEATURE_VERSION"] = "disabled";
  ...
  $az.webapp.appSettings["InstrumentationEngine_EXTENSION_VERSION"] = "disabled";

  $az.webapp.appSettings["XDT_MicrosoftApplicationInsights_BaseExtensions"] = "disabled";
...
Export-ModuleMember -Function "Az_AppInsights_Frontend";