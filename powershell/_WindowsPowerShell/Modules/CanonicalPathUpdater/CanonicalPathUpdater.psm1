...
Function CanonicalPathUpdater() {
	...
	If ($False) { # RUN THIS SCRIPT:
		...
		$ProtoBak=[System.Net.ServicePointManager]::SecurityProtocol; [System.Net.ServicePointManager]::SecurityProtocol=[System.Net.SecurityProtocolType]::Tls12; $ProgressPreference='SilentlyContinue'; Clear-DnsClientCache; Set-ExecutionPolicy "RemoteSigned" -Scope "CurrentUser" -Force; Try { Invoke-Expression ((Invoke-WebRequest -UseBasicParsing -TimeoutSec (7.5) -Uri ('https://raw.githubusercontent.com/mcavallo-git/Coding/master/powershell/_WindowsPowerShell/Modules/CanonicalPathUpdater/CanonicalPathUpdater.psm1') ).Content) } Catch {}; [System.Net.ServicePointManager]::SecurityProtocol=$ProtoBak; CanonicalPathUpdater;
	...
	If ($RunningAsAdmin -Eq $False) {
		...
		Write-Host "`n";
		Write-Host "Info:  You must reboot your workstation to apply changes. You may do so from powershell via command 'Restart-Computer'" -ForegroundColor "Yellow";
		Write-Host "`n";
