...
function ExclusionsListUpdate {
	...
	If ((RunningAsAdministrator) -eq ($False)) {
		...
		$ExcludedProcesses += @{ Dirname=${SysRoot}; AddDir="WinSxS"; Depth="1"; Parent=""; Basename="amd64_microsoft-windows-servicingstack*\TiWorker.exe"; };
		$ExcludedProcesses += @{ Dirname=${SysRoot}; AddDir="WinSxS"; Depth="1"; Parent=""; Basename="x86_microsoft-windows-servicingstack*\TiWorker.exe"; };
