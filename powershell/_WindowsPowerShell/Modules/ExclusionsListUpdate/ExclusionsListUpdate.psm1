...
function ExclusionsListUpdate {
	...
	If ((RunningAsAdministrator) -eq ($False)) {
		...
		$ExcludedProcesses += @{ Dirname=${SysRoot}; AddDir="WinSxS\amd64_microsoft-windows-servicingstack*"; Depth="1"; Parent=""; Basename="TiWorker.exe"; };
		$ExcludedProcesses += @{ Dirname=${SysRoot}; AddDir="WinSxS\x86_microsoft-windows-servicingstack*"; Depth="1"; Parent=""; Basename="TiWorker.exe"; };
