...
Function Get-SystemSpecs() {
  ...
  Add-Content -Path ("${Logfile}") -Value ("--- ");
  (Get-CimInstance -ClassName "Win32_Processor" | Select-Object -Property CurrentClockSpeed,MaxClockSpeed,Name,NumberOfCores,NumberOfLogicalProcessors | Format-Table) -creplace '\P{IsBasicLatin}' | Out-File -Width 16384 -Append -FilePath ("${Logfile}");
  ...
  Add-Content -Path ("${Logfile}") -Value ("--- ");
  (Get-CimInstance -ClassName "Win32_VideoController" | Select-Object -Property AdapterRAM,Description,DriverVersion,Name | Format-Table) -creplace '\P{IsBasicLatin}' | Out-File -Width 16384 -Append -FilePath ("${Logfile}");
  ...
  Add-Content -Path ("${Logfile}") -Value ("--- ");
  (Get-CimInstance -ClassName "Win32_PhysicalMemory" | Select-Object -Property BankLabel,Capacity,DeviceLocator,FormFactor,Manufacturer,PartNumber,Speed | Format-Table) -creplace '\P{IsBasicLatin}' | Out-File -Width 16384 -Append -FilePath ("${Logfile}");
  Add-Content -Path ("${Logfile}") -Value ("");
  Add-Content -Path ("${Logfile}") -Value ("--- ");
  Add-Content -Path ("${Logfile}") -Value ("-----  Motherboard RAM Limits (MaxCapacity in kilobytes, MemoryDevices is total RAM Slots) ");
  Add-Content -Path ("${Logfile}") -Value ("--- ");
  (Get-CimInstance -ClassName "Win32_PhysicalMemoryArray" | Select-Object -Property MaxCapacity,MemoryDevices | Format-Table) -creplace '\P{IsBasicLatin}' | Out-File -Width 16384 -Append -FilePath ("${Logfile}");
  ...
  Add-Content -Path ("${Logfile}") -Value ("--- ");
  (Get-CimInstance -ClassName "Win32_DiskDrive" | Select-Object -Property Caption,DeviceID,Index,Partitions,Size | Format-Table) -creplace '\P{IsBasicLatin}' | Out-File -Width 16384 -Append -FilePath ("${Logfile}");
  ...
  Add-Content -Path ("${Logfile}") -Value ("--- ");
  (Get-CimInstance -ClassName "Win32_ComputerSystem" | Select-Object -Property Manufacturer,Model,Name,SystemType | Format-Table) -creplace '\P{IsBasicLatin}' | Out-File -Width 16384 -Append -FilePath ("${Logfile}");
  ...
  Write-Output "--- " | Out-File -Width 16384 -Append -FilePath ("${Logfile}");
  (Get-CimInstance -ClassName "Win32_BaseBoard" | Select-Object -Property Manufacturer,Product,SerialNumber | Format-Table) -creplace '\P{IsBasicLatin}' | Out-File -Width 16384 -Append -FilePath ("${Logfile}");
  Add-Content -Path ("${Logfile}") -Value ("");
  Add-Content -Path ("${Logfile}") -Value ("--- ");
  Add-Content -Path ("${Logfile}") -Value ("-----  BIOS ");
  Add-Content -Path ("${Logfile}") -Value ("--- ");
  (Get-CimInstance -ClassName "Win32_BIOS" | Select-Object -Property ReleaseDate,SMBIOSBIOSVersion,SMBIOSMajorVersion,SMBIOSMinorVersion | Format-Table) -creplace '\P{IsBasicLatin}' | Out-File -Width 16384 -Append -FilePath ("${Logfile}");
  ...
  Add-Content -Path ("${Logfile}") -Value ("--- ");
  (Get-CimInstance -ClassName "Win32_NetworkAdapterConfiguration" | Select-Object -Property Index,Description,IPAddress,MACAddress,DefaultIPGateway,DHCPServer | Format-Table) -creplace '\P{IsBasicLatin}' | Out-File -Width 16384 -Append -FilePath ("${Logfile}");
  ...
  Add-Content -Path ("${Logfile}") -Value ("--- ");
  (Get-CimInstance -ClassName "Win32_OperatingSystem" | Select-Object -Property Caption,OSArchitecture,Version | Format-Table) -creplace '\P{IsBasicLatin}' | Out-File -Width 16384 -Append -FilePath ("${Logfile}");
  ...
  Add-Content -Path ("${Logfile}") -Value ("--- ");
  (Get-CimInstance -ClassName "Win32_ComputerSystem" | Select-Object -Property Domain,PartOfDomain,PrimaryOwnerName,UserName | Format-Table) -creplace '\P{IsBasicLatin}' | Out-File -Width 16384 -Append -FilePath ("${Logfile}");
