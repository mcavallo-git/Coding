...
# HomeAssistant - Install 'X-Sense' HACS Integration
...
# Citation(s)
#
#   github.com  |  "GitHub - Jarnsen/ha-xsense-component_test: HACS Integration for X-Sense devices"  |  https://github.com/Jarnsen/ha-xsense-component_test
#
# ------------------------------------------------------------
-->