...
/etc/init.d/hostd restart;  # Restart the [ ESXi host daemon ] and the [ vCenter Agent ] service (should be accessible again within ~15-30 seconds) Note: Doesn't affect any VMs
