...
| <h4>NUC Generation</h4> | <h4>NUC Family</h4> | <h4>NUC Model</h4> | <h4>CPU Model</h4>           | <h4>CPU Cores<br /> & Threads (T)</h4> | <h4>CPU Frequency<br />(Base/Max)</h4>   | <h4>CPU Capacity<br />(ESXi)</h4> | <h4>Price<br />(Intel RCP)</h4> | <h4>(Cap./Price) * 100</h4> |
| :---------------------- | :------------------ | :----------------- | :--------------------------- | :------------------------------------- | :--------------------------------------- | :-------------------------------- | :------------------------------ | :------------------------------ |
...
| `11th Gen`              | `Pro`               | `NUC11TNHi5`       | `i5-1135G7`                  | `4 (8T)`                               | `2.4/4.2 GHz`                            | `9.6 GHz`                         | `467 $ (USD)`                   | `2.06`                          |
| <hr />                  | <hr />              | <hr />             | <hr />                       | <hr />                                 | <hr />                                   | <hr />                            | <hr />                          | <hr />                          |
| `10th Gen`              | `Performance`       | `NUC10i7FNH`       | `i7-10710U`                  | `6 (12T)`                              | `1.1/4.7 GHz`                            | `6.6 GHz`                         | `602 $ (USD)`                   | `1.10`                          |
| `10th Gen`              | `Performance`       | `NUC10i5FNH`       | `i5-10210U`                  | `4 (8T)`                               | `1.6/4.2 GHz`                            | `5.6 GHz`                         | `428 $ (USD)`                   | `1.31`                          |
| `10th Gen`              | `Performance`       | `NUC10i3FNH`       | `i3-10110U`                  | `2 (4T)`                               | `2.1/4.1 GHz`                            | `4.2 GHz`                         | `324 $ (USD)`                   | `1.30`                          |
| <hr />                  | <hr />              | <hr />             | <hr />                       | <hr />                                 | <hr />                                   | <hr />                            | <hr />                          | <hr />                          |
| `9th Gen`               | `Extreme`           | `NUC9i9QNX`        | `i9-9980HK`                  | `8 (16T)`                              | `2.4/5.0 GHz`                            | `19.2 GHz`                        | `1068 $ (USD)`                  | `1.80`                          |
| `9th Gen`               | `Pro`               | `NUC9VXQNX`        | `E-2286M` <sub>(Xeon)</sub>  | `8 (16T)`                              | `2.4/5.0 GHz`                            | `19.2 GHz`                        | `1564 $ (USD)`                  | `1.23`                          |
| `9th Gen`               | `Pro`               | `NUC9V7QNX`        | `i7-9850H`                   | `6 (12T)`                              | `2.6/4.6 GHz`                            | `15.6 GHz`                        | `1256 $ (USD)`                  | `1.24`                          |
| `9th Gen`               | `Extreme`           | `NUC9i7QNX`        | `i7-9750H`                   | `6 (12T)`                              | `2.6/4.5 GHz`                            | `15.6 GHz`                        | `768 $ (USD)`                   | `2.03`                          |
| `9th Gen`               | `Extreme`           | `NUC9i5QNX`        | `i5-9300H`                   | `4 (8T)`                               | `2.4/4.1 GHz`                            | `9.6 GHz`                         | `608 $ (USD)`                   | `1.58`                          |
| <hr />                  | <hr />              | <hr />             | <hr />                       | <hr />                                 | <hr />                                   | <hr />                            | <hr />                          | <hr />                          |
| `8th Gen`               | `Pro`               | `NUC8v7PNH`        | `i7-8665U`                   | `4 (8T)`                               | `1.9/4.8 GHz`                            | `7.6 GHz`                         | `659 $ (USD)`                   | `1.15`                          |
| `8th Gen`               | `(None)`            | `NUC8i7BEH`        | `i7-8559U`                   | `4 (8T)`                               | `2.7/4.5 GHz`                            | `10.8 GHz`                        | `564 $ (USD)` <sub>(Amzn)</sub> | `1.91`                          |
| `8th Gen`               | `Pro`               | `NUC8v5PNH`        | `i5-8365U`                   | `4 (8T)`                               | `1.6/4.1 GHz`                            | `6.4 GHz`                         | `487 $ (USD)`                   | `1.31`                          |
| `8th Gen`               | `(None)`            | `NUC8i5BEH`        | `i5-8259U`                   | `4 (8T)`                               | `2.3/3.8 GHz`                            | `9.2 GHz`                         | `416 $ (USD)`                   | `2.21`                          |
| `8th Gen`               | `Pro`               | `NUC8i3PNH`        | `i3-8145U`                   | `2 (4T)`                               | `2.1/3.9 GHz`                            | `4.2 GHz`                         | `325 $ (USD)`                   | `1.29`                          |
| `8th Gen`               | `(None)`            | `NUC8i3BEH`        | `i3-8109U`                   | `2 (4T)`                               | `3.0/3.6 GHz`                            | `6.0 GHz`                         | `317 $ (USD)`                   | `1.89`                          |
| <hr />                  | <hr />              | <hr />             | <hr />                       | <hr />                                 | <hr />                                   | <hr />                            | <hr />                          | <hr />                          |
| `7th Gen`               | `(None)`            | `NUC7i7DNHE`       | `i7-8650U`                   | `4 (8T)`                               | `1.9/4.2 GHz`                            | `7.6 GHz`                         | `694 $ (USD)` <sub>(eBay)</sub> | `1.10`                          |
| `7th Gen`               | `(None)`            | `NUC7i7BNH`        | `i7-7567U`                   | `2 (4T)`                               | `3.5/4.0 GHz`                            | `7.0 GHz`                         | `247 $ (USD)` <sub>(eBay)</sub> | `2.83`                          |
| `7th Gen`               | `(None)`            | `NUC7i5DNHE`       | `i5-7300U`                   | `2 (4T)`                               | `2.6/3.5 GHz`                            | `5.2 GHz`                         | `409 $ (USD)`                   | `1.27`                          |
| `7th Gen`               | `(None)`            | `NUC7i5BNH`        | `i5-7260U`                   | `2 (4T)`                               | `2.2/3.4 GHz`                            | `4.4 GHz`                         | `320 $ (USD)` <sub>(eBay)</sub> | `1.38`                          |
| `7th Gen`               | `(None)`            | `NUC7i3DNHE`       | `i3-7100U`                   | `2 (4T)`                               | `2.4 GHz` <sub>(No Turbo)</sub>          | `4.8 GHz`                         | `258 $ (USD)`                   | `1.86`                          |
| `7th Gen`               | `(None)`            | `NUC7i3BNH`        | `i3-7100U`                   | `2 (4T)`                               | `2.4 GHz` <sub>(No Turbo)</sub>          | `4.8 GHz`                         | `332 $ (USD)` <sub>(Amzn)</sub> | `1.45`                          |
| <hr />                  | <hr />              | <hr />             | <hr />                       | <hr />                                 | <hr />                                   | <hr />                            | <hr />                          | <hr />                          |
| `6th Gen`               | `(None)`            | `NUC6i7KYK`        | `i7-6770HQ`                  | `4 (8T)`                               | `2.6/3.5 GHz`                            | `10.4 GHz`                        | `378 $ (USD)` <sub>(Amzn)</sub> | `2.75`                          |
| `6th Gen`               | `(None)`            | `NUC6i5SYH`        | `i5-6260U`                   | `2 (4T)`                               | `1.8/2.9 GHz`                            | `3.6 GHz`                         | `349 $ (USD)` <sub>(Amzn)</sub> | `1.03`                          |
| `6th Gen`               | `(None)`            | `NUC6i3SYH`        | `i3-6100U`                   | `2 (4T)`                               | `2.3 GHz` <sub>(No Turbo)</sub>          | `4.6 GHz`                         | `255 $ (USD)` <sub>(Amzn)</sub> | `1.80`                          |
| <hr />                  | <hr />              | <hr />             | <hr />                       | <hr />                                 | <hr />                                   | <hr />                            | <hr />                          | <hr />                          |
| `5th Gen`               | `(None)`            | `NUC5i7RYH`        | `i7-5557U`                   | `2 (4T)`                               | `3.1/3.4 GHz`                            | `6.2 GHz`                         | `115 $ (USD)` <sub>(eBay)</sub> | `5.39`                          |
| `5th Gen`               | `(None)`            | `NUC5i5MYHE`       | `i5-5300U`                   | `2 (4T)`                               | `2.3/2.9 GHz`                            | `4.6 GHz`                         | `145 $ (USD)` <sub>(eBay)</sub> | `3.17`                          |
| `5th Gen`               | `(None)`            | `NUC5i5RYH`        | `i5-5250U`                   | `2 (4T)`                               | `1.6/2.7 GHz`                            | `3.2 GHz`                         | `123 $ (USD)` <sub>(eBay)</sub> | `2.60`                          |
| `5th Gen`               | `(None)`            | `NUC5i3RYH`        | `i3-5010U`                   | `2 (4T)`                               | `2.1 GHz` <sub>(No Turbo)</sub>          | `4.2 GHz`                         | `79 $ (USD)`  <sub>(eBay)</sub> | `5.32`                          |
| <hr />                  | <hr />              | <hr />             | <hr />                       | <hr />                                 | <hr />                                   | <hr />                            | <hr />                          | <hr />                          |
