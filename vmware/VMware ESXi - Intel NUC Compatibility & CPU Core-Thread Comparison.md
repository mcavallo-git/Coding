...
| <h4>NUC Generation</h4>         | <h4>NUC Family</h4>        | <h4>NUC Model</h4> | <h4>CPU Model</h4>           | <h4>CPU Cores<br /> & Threads (T)</h4>      | <h4>CPU Frequency<br />(Base/Max)</h4>   |
| :------------------------------ | :------------------------- | :----------------- | :--------------------------- | :-------------------------------- | :--------------------------------------- |
| <hr />                          | <hr />                     | <hr />             | <hr />                       | <hr />                            | <hr />                                   |
| `13th Gen`                      | `Extreme`                  | `NUC13RNGi9`       | `i9-13900K`                  | `8 (16T) (P)`<br />`16 (16T) (E)` | `3.0/5.4 GHz (P)`<br />`2.2/4.3 GHz (E)` |
| `13th Gen`                      | `Extreme`                  | `NUC13RNGi7`       | `i7-13700K`                  | `8 (16T) (P)`<br />`8 (8T) (E)`   | `3.4/5.3 GHz (P)`<br />`2.5/4.2 GHz (E)` |
| `13th Gen`                      | `Extreme`                  | `NUC13RNGi5`       | `i5-13600K`                  | `6 (12T) (P)`<br />`8 (8T) (E)`   | `3.5/5.1 GHz (P)`<br />`2.6/3.9 GHz (E)` |
| <hr />                          | <hr />                     | <hr />             | <hr />                       | <hr />                            | <hr />                                   |
| `12th Gen`                      | `Extreme`                  | `NUC12DCMi9`       | `i9-12900`                   | `8 (16T) (P)`<br />`8 (8T) (E)`   | `2.4/5.0 GHz (P)`<br />`1.8/3.8 GHz (E)` |
| `12th Gen`                      | `Pro`                      | `NUC12WSHv7`       | `i7-1270P`                   | `4 (8T) (P)`<br />`8 (8T) (E)`    | `2.2/4.8 GHz (P)`<br />`1.6/3.5 GHz (E)` |
| `12th Gen`                      | `Pro`                      | `NUC12WSHi7`       | `i7-1260P`                   | `4 (8T) (P)`<br />`8 (8T) (E)`    | `2.1/4.7 GHz (P)`<br />`1.5/3.4 GHz (E)` |
